...
class Game:
    ...
    # check to see if client is the winner
    ...
    # receive message from server from the other client, update the board with their position
    ...
    # updates the board based on the user input, or message received from other client
    ...
    def end_win(self, msg=None):
        if msg is not None:
            ...
            #print out You win for the winner
            print('You win!')
        send(DISCONNECT_MESSAGE)
        quit()
# starts the game
